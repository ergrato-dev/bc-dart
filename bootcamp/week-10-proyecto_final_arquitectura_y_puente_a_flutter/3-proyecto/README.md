# Proyecto Semana 10 — Proyecto Final: Arquitectura y Puente a Flutter

> 🚧 **Contenido en desarrollo.** Usa el prompt `nuevo-proyecto` para generar el proyecto completo.

## 🎯 Objetivo

Implementar los conceptos de **Proyecto Final: Arquitectura y Puente a Flutter** aplicados a tu dominio asignado.
